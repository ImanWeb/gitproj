...
<table width="800">
  ...
  <tr>    
    <td>Do you want to be subscribed to our mailing list?</td>
    <td><input type="radio" name="subbed" value="1" <?php if ($subbed == '1') echo 'checked="checked"'; ?> /> Yes &nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" name="subbed" value="0" <?php if ($subbed == '0') echo 'checked="checked"'; ?> /> No</td>
  </tr>
  <tr>
	<td></td>
