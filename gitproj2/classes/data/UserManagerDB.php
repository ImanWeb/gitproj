...
class UserManagerDB
{
    ...
    public static function saveUser(User $user){
        ...
        $stmt->bind_param("isssssss", $user->id,$user->firstName, $user->lastName, $user->email,$user->password, $user->account_creation_time, $user->role, $user->subbed); 
        $stmt->execute();
        if($stmt->errno!=0){
            printf("Error: %s.\n",$stmt->error);
        }
